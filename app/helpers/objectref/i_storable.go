...
func (it *DBObjectRef) Save() error {
	return env.ErrorNew(ConstErrorModule, ConstErrorLevel, "d41d76c0fa634418b90ebde64864ecaa", "not implemented")
}

// Load loads information from DB
func (it *DBObjectRef) Load(id string) error {
	return env.ErrorNew(ConstErrorModule, ConstErrorLevel, "d65b0e21c51d4460a32ae4f09a84f421", "not implemented")
}

// Delete removes current object instance from DB
func (it *DBObjectRef) Delete() error {
	return env.ErrorNew(ConstErrorModule, ConstErrorLevel, "61c0b53db2a4499abe8b6f2101f1ab97", "not implemented")
}
