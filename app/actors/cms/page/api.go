...
func restCMSPageList(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !ok {
		if params.Request.Method == "POST" {
			return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "4813d3ab67e44abfb1f8906e75cdd907", "unexpected request content")
		}
...
func restCMSPageGet(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !present {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "4c0a288a03a443759fb31abd7981aecd", "cms page id should be specified")
	}
	...
	if api.ValidateAdminRights(params) != nil && !cmsPage.GetEnabled() {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "fa76f5ac0cce46709e62197a600ec0b9", "cms page is not available")
	}
...
func restCMSPageUpdate(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !present {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "f128b02f4ca5494b920d5f320d112636", "cms page id should be specified")
	}
...
func restCMSPageDelete(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	pageID, present := params.RequestURLParams["id"]
	if !present {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "20545153b1714638b47e15317e85262c", "cms page id should be specified")
	}
