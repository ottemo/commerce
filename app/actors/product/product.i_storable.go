...
func (it *DefaultProduct) Load(loadID string) error {
	...
	if err != nil {
		return env.ErrorNew(ConstErrorModule, ConstErrorLevel, "a671dee4-b95b-11e5-a86b-28cfe917b6c7", "Error in Product.Load(), unable to find and load product with ID: "+loadID)
	}
