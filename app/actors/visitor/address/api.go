...
func restCreateVisitorAddress(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if _, ok := reqData["visitor_id"]; !ok {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "a9da4ac4d07348f3b0622ba536d2c577", "visitor id was not specified")
	}
...
func restUpdateVisitorAddress(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "fe7814c085fe4d60a134415f7ac12075", "visitor address 'id' was not specified")
	}
...
func restDeleteVisitorAddress(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	addressID, isSpecifiedID := params.RequestURLParams["id"]
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "eec1ef1b25d94dbe8bd2b907a0897203", "visitor address id was not specified")
	}
...
func restListVisitorAddress(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !ok {
		if params.Request.Method == "POST" {
			return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "5f49924d5d934c82b7d2eb0bb998055f", "unexpected request content")
		}
	...
	if !isSpecifiedID {
		...
		if sessionVisitorID == "" {
			return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "2ac4c16b9241406eb35a399813bb6ca5", "you are not logined in")
		}
...
func restGetVisitorAddress(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "b94882c6bbdd428d88b07ea5623d80f7", "visitor 'id' was not specified")
	}
