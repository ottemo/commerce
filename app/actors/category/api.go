...
func restListCategories(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !ok {
		if params.Request.Method == "POST" {
			return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "760bdd87468c4e6f913103e9df4fc6ce", "unexpected request content")
		}
...
func restCreateCategory(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if _, present := reqData["name"]; !present {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "521b50d60d98491a8e3a37678fbbccfe", "category name was not specified")
	}
...
func restDeleteCategory(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "f1507b00337e490382445cf959dde3a4", "category id was not specified")
	}
...
func restUpdateCategory(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	categoryID, isSpecifiedID := params.RequestURLParams["id"]
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "389975e7611c4d6c8b4dbca450f5f7e7", "category id was not specified")
	}
...
func restListCategoryLayers(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if api.ValidateAdminRights(params) != nil && !categoryModel.GetEnabled() {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "d46dadf8373a4247a81efbbe39a7fe74", "category is not available")
	}
...
func restListCategoryProducts(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "12400cff34fe4cf5ac6e41625f9e3d5a", "category id was not specified")
	}
	...
	if api.ValidateAdminRights(params) != nil && !categoryModel.GetEnabled() {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "9a6f080ddfa44f8c8a0cec31cbe1cd87", "category is not available")
	}
...
func restAddCategoryProduct(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	categoryID, isSpecifiedID := params.RequestURLParams["categoryID"]
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "2fc40bdc3c8e4a9c910bcca62cda1b77", "category id was not specified")
	}
	productID, isSpecifiedID := params.RequestURLParams["productID"]
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "190a3d6077694908b38380bc143128da", "product id was not specified")
	}
...
func restRemoveCategoryProduct(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	categoryID, isSpecifiedID := params.RequestURLParams["categoryID"]
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "dc083799bccb48c8bd565dcd0a0f6031", "category id was not specified")
	}
	productID, isSpecifiedID := params.RequestURLParams["productID"]
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "9ffd262641924726849ec7a2416fab3a", "product id was not specified")
	}
...
func restGetCategory(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	categoryID, isSpecifiedID := params.RequestURLParams["id"]
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "3c336fd71a184aea9eb0460d746f8dfa", "category id was not specified")
	}
	...
	if api.ValidateAdminRights(params) != nil && !categoryModel.GetEnabled() {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "80615e04f43d42a4948239a5e7f8ccb7", "category is not available")
	}
...
func restCategoryProductsCount(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	categoryID, isSpecifiedID := params.RequestURLParams["categoryID"]
	if !isSpecifiedID {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "e1003839d91c444596c830e481b8347e", "category id was not specified")
	}
	...
	if api.ValidateAdminRights(params) != nil && !categoryModel.GetEnabled() {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "9c2efb6acd284dd2ba7f5c1fe7c0df30", "category is not available")
	}
	...
	for _, row := range rowData {
		...
		for idx := len(pathStack) - 1; idx >= 0; idx-- {
			...
			if strings.Contains(currentPath, parentPath) {
				...
				if !ok {
					return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "c94e54a453dc4ed2bac47e9d93958765", "category tree builder internal error")
				}
