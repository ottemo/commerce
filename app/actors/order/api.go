...
func restOrderList(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !ok {
		if params.Request.Method == "POST" {
			return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "d4a758dd3f0344c5b95ec28a10aadf3c", "unexpected request content")
		}
...
func restOrderGet(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !present {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "723ef443f97444559be0a8af13916554", "order id should be specified")
	}
...
func restOrderUpdate(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if !present {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "20a08638e9e6428bb70ca418d7821e4b", "order id should be specified")
	}
...
func restOrderDelete(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	blockID, present := params.RequestURLParams["id"]
	if !present {
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "fc3011c7e58c4433b9b0881a7ba005cf", "order id should be specified")
	}
