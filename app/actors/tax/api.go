...
func restTaxCSVDownload(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if dbEngine := db.GetDBEngine(); dbEngine != nil {
		...
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "4cc9eb51663e4ebc9b235e7dee56e078", "can't get DB engine")
	}
...
func restTaxCSVUpload(params *api.StructAPIHandlerParams) (interface{}, error) {
	...
	if dbEngine := db.GetDBEngine(); dbEngine != nil {
		...
		return nil, env.ErrorNew(ConstErrorModule, ConstErrorLevel, "cc1f5af3fd1c4da8a4c2f40613eb682f", "can't get DB engine")
	}
