...
/*
Package tests represents set of test writing helpers. It provides a set of functions you can use for starting Ottemo
application in a test mode, prepare randomized data, fill DB with sample data, which is use-full during GO tests writing.
